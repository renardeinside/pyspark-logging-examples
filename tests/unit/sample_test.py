from pyspark_logging_examples.workloads.sample_etl_job import SampleETLJob
from pyspark_logging_examples.workloads.sample_ml_job import SampleMLJob
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    etl_job.launch()
    table_name = (
        f"{test_etl_config['output']['database']}.{test_etl_config['output']['table']}"
    )
    ...
    # test_ml_config = {
    #     "input": common_config,
    #     "experiment": "/Shared/pyspark-logging-examples/sample_experiment",
    # }
